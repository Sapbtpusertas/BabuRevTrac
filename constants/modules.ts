...
import { Figure1_1 } from '../components/figures/Figure1_1';
import { Figure2_1 } from '../components/figures/Figure2_1';
import { Figure3_1 } from '../components/figures/Figure3_1';
import { Figure4_1 } from '../components/figures/Figure4_1';
import { Figure4_2 } from '../components/figures/Figure4_2';
import { Figure5_1 } from '../components/figures/Figure5_1';
import { Figure5_2 } from '../components/figures/Figure5_2';
...
const P = (...children: React.ReactNode[]) => React.createElement('p', { className: "mb-4" }, ...children);
...
export const modulesData: Module[] = [
  {
    ...
    content: React.createElement(ChapterContentWrapper, null,
      ...
      P("The design philosophy and feature set of Rev-Trac Platinum are structured around four foundational pillars. These pillars represent the core value propositions of the platform and provide a framework for understanding its capabilities.", React.createElement(Sup, null, "1")),
      createList([
      ...
      P("Together, these four pillars form a comprehensive framework that unifies SAP change processes, empowering teams to minimize risk, reduce manual effort, and adapt rapidly to business needs, ensuring every change delivers value without disruption.")
    )
  },
  {
    id: 'modal-ch2',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("A successful Rev-Trac implementation begins long before the software is installed. Thorough pre-implementation planning is essential to ensure that the technical environment is prepared, project scope is clearly defined, and all stakeholder teams are aligned. This chapter provides the technical groundwork for SAP Basis Administrators, Project Managers, and Infrastructure Engineers, guiding them through the necessary preparations, technical requirements, and the phased installation process."),
      React.createElement(H3, null, "2.1 Landscape and System Prerequisites"),
      P("Rev-Trac Platinum is designed to manage change across a wide and diverse range of SAP solutions and landscapes. Its compatibility extends from legacy SAP ECC systems to the latest SAP S/4HANA on-premise and cloud editions, as well as the SAP Business Technology Platform (BTP).", React.createElement(Sup, null, "1"), " It is fundamentally architected for complex environments involving multiple systems, parallel development tracks, and hybrid on-premise/cloud scenarios.", React.createElement(Sup, null, "3")),
      ...
      // FIX: Pass `children` as a property in the props object for `FigureWrapper` to satisfy TypeScript's type checking.
      React.createElement(FigureWrapper, { caption: "Figure 2.1: A diagram illustrating critical network paths: the WebCore VM to the Rev-Trac Master, the WebCore to external services, and RFC connections from the Master to all managed SAP systems.", children: React.createElement(Figure2_1, null) }),
      React.createElement(H3, null, "2.3 Step-by-Step Installation Guide"),
      P("The installation of Rev-Trac Platinum is a structured process that is typically performed with the assistance of the vendor... The process is quantifiable, and a clear timeline with a go-live date is generally established before the project begins.", React.createElement(Sup, null, "14")),
      React.createElement(H4, null, "Phase 1: Scoping and Planning"),
      P("Defining the project scope, identifying all systems to be managed, designing the change management workflows, and establishing the project timeline."),
      React.createElement(H4, null, "Phase 2: Customer Landscape Preparation"),
      P("Provisioning the server for the WebCore VM, preparing the Rev-Trac Master SAP system, configuring RFCs, and implementing firewall changes."),
      React.createElement(H4, null, "Phase 3: Implementation and Administrator Training"),
      P("Importing the Rev-Trac ABAP add-on, deploying the WebCore VM, performing foundational configuration, and conducting administrator training."),
      React.createElement(H4, null, "Phase 4: Landscape Go-Live, User Training, and Support"),
      P("Training for end-users, and a period of hypercare support."),
      React.createElement(H4, null, "Phase 5: Integration with the DevOps Toolchain"),
      P("Integrating with external tools like Jira and ServiceNow via the WebCore."),
      React.createElement(H4, null, "Phase 6: Sign-off"),
      P("The formal sign-off and closure of the implementation project.")
    )
  },
  {
    id: 'modal-ch3',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("Once Rev-Trac Platinum is installed, the next critical stage is to configure the application to reflect the organization's structure, landscape, and change management processes. This foundational configuration transforms the raw software into a tailored governance tool."),
      React.createElement(H3, null, "3.1 The Rev-Trac Console: Your Central Administration Hub"),
      P("The primary interface for both administrators and end-users within the SAP environment is the Rev-Trac Console. It is accessed via the SAP transaction code /RSC/RT or, more directly, /n/rsc/rt01.", React.createElement(Sup, null, "3"), " For administrators, the console's menu bar provides access to the full suite of configuration options... For end-users, the console presents a personalized dashboard... featuring tabs that provide a consolidated view of all Rev-Trac Requests (RTRs) for which they have a specific responsibility.", React.createElement(Sup, null, "25")),
      // FIX: Pass `children` as a property in the props object for `FigureWrapper` to satisfy TypeScript's type checking.
      React.createElement(FigureWrapper, { caption: "Figure 3.1: An annotated screenshot of the Rev-Trac Console, highlighting the menu bar for configuration, the main panel with user-specific tabs, and the 'Create request' button.", children: React.createElement(Figure3_1, null) }),
      React.createElement(H3, null, "3.2 Configuring the Organization Structure: Users, Teams, and Roles"),
      P("The first and most important configuration task is to map the organization's human structure into Rev-Trac. This is accomplished via the 'Organization' menu... This structure forms the basis for all approval workflows and access controls.", React.createElement(Sup, null, "22")),
      ...
      P("After defining the people, the next step is to define the systems... This configuration involves two main activities: System Registration and Process and Migration Path Definition. The path a change takes through the landscape... is dynamically determined based on a combination of the 'Project' and 'Request Type' selected when a change request is created.", React.createElement(Sup, null, "25")),
      P("This highly granular and context-aware control model is a core strength of Rev-Trac. It allows an organization to move away from a rigid, one-size-fits-all change process and instead tailor the level of governance and automation to the specific risk and urgency of each change.")
    )
  },
  {
    id: 'modal-ch4',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("With the foundational configuration in place, the focus shifts to the daily operational use of Rev-Trac. The entire change management process revolves around a central object: the Rev-Trac Request (RTR)."),
      React.createElement(H3, null, "4.1 Creating a Rev-Trac Request (RTR): A Detailed Walkthrough"),
      P("The lifecycle of every managed change begins with the creation of an RTR... The combination of Project and Request Type is critical as it dictates which approval workflow and migration path the RTR will follow.", React.createElement(Sup, null, "25")),
      // FIX: Pass `children` as a property in the props object for `FigureWrapper` to satisfy TypeScript's type checking.
      React.createElement(FigureWrapper, { caption: "Figure 4.1: An annotated screenshot of the 'Create request details' screen, with key fields like Title, Project, and Request Type highlighted.", children: React.createElement(Figure4_1, null) }),
      React.createElement(H3, null, "4.2 Managing Transports and Documentation within an RTR"),
      P("A foundational principle... is that every technical change (i.e., every transport) must be justified by and linked to an approved business requirement (i.e., an RTR).", React.createElement(Sup, null, "9"), " When a developer attempts to save changes... a Rev-Trac enforcement popup appears.", React.createElement(Sup, null, "27"), " This dialog prevents the creation of \"rogue\" or undocumented transports. This enforcement... fundamentally shifts developer behavior from optional compliance to mandatory, system-enforced governance.", React.createElement(Sup, null, "28")),
      ...
      P("Once an RTR is created... it progresses through a series of predefined statuses... strictly controlled by the configured approval workflow.", React.createElement(Sup, null, "3"), " When an approver signs off on a status, Rev-Trac captures this as a digital signature, creating a permanent, time-stamped, and auditable record of the approval.", React.createElement(Sup, null, "3")),
      // FIX: Pass `children` as a property in the props object for `FigureWrapper` to satisfy TypeScript's type checking.
      React.createElement(FigureWrapper, { caption: "Figure 4.2: A visual representation of a sample workflow, showing status progression from 'In Development' to 'Complete', with each transition marked as a digital signature approval gate.", children: React.createElement(Figure4_2, null) }),
      React.createElement(H3, null, "4.4 Navigating the Rev-Trac Workbench (/RSC/RTWB)"),
      P("The Rev-Trac Workbench (T-code /RSC/RTWB) is the main operational dashboard for gaining visibility and control over all in-flight changes.", React.createElement(Sup, null, "3"), " The Workbench provides a powerful search facility... The search results are displayed in a hierarchical tree structure... This makes the Workbench an indispensable tool for Change Managers, Release Managers, and Basis Administrators.")
    )
  },
  {
    id: 'modal-ch5',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("Rev-Trac Platinum distinguishes itself with a suite of advanced safety features designed to protect system stability... These capabilities proactively prevent common but high-impact errors related to transport sequencing and parallel development."),
      React.createElement(H3, null, "5.1 Deep Dive: The Overtake and Overwrite Protection System (OOPS)"),
      P("The Overtake and Overwrite Protection System (OOPS) is Rev-Trac's signature and most critical safety feature.", React.createElement(Sup, null, "3"), " It is a proactive prevention system that addresses... out-of-sequence transport migrations. OOPS analyzes the version history of objects... to detect two primary types of conflicts before a migration occurs", React.createElement(Sup, null, "2"), ":"),
      createList([
      ...
      // FIX: Pass `children` as a property in the props object for `FigureWrapper` to satisfy TypeScript's type checking.
      React.createElement(FigureWrapper, { caption: "Figure 5.1: A diagram illustrating OOPS conflict scenarios. 'Overwrite' shows an older version being blocked. 'Overtake' shows a transport being blocked because a newer version in another transport should be imported first.", children: React.createElement(Figure5_1, null) }),
      React.createElement(H3, null, "5.2 Managing Parallel Development: Object Locking and Retrofit"),
      P("In large organizations, it is common to have multiple development streams running in parallel (e.g., a major project (N+1) and production support (N))."),
      ...
      P("Manually re-keying every production fix from the ECC landscape into the S/4HANA project landscape is extraordinarily time-consuming, costly, and prone to human error.", React.createElement(Sup, null, "2"), " Rev-Trac's Retrofit feature automates this process.", React.createElement(Sup, null, "7"), " This automation is a key strategic enabler for large-scale transformation projects."),
      React.createElement(H3, null, "5.3 Advanced Dependency Management"),
      P("To manage logical dependencies... Rev-Trac allows developers to define explicit dependencies.", React.createElement(Sup, null, "3"), " By defining a \"pre-requisite\" relationship, the developer instructs Rev-Trac that one change must be successfully deployed before another is allowed to proceed.", React.createElement(Sup, null, "26")),
      // FIX: Pass `children` as a property in the props object for `FigureWrapper` to satisfy TypeScript's type checking.
      React.createElement(FigureWrapper, { caption: "Figure 5.2: A screenshot of the dependency definition screen, showing how a user can specify that RTR-12345 is a pre-requisite for RTR-12346.", children: React.createElement(Figure5_2, null) })
    )
  },
  {
    id: 'modal-ch6',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("Rev-Trac's Release Management Workbench (RMW) is a powerful feature designed specifically to address the challenge of orchestrating large-scale deployments, enabling the management and deployment of many changes as a single, cohesive unit.", React.createElement(Sup, null, "13")),
      React.createElement(H3, null, "6.1 Introduction to the Release Management Workbench (RMW)"),
      P("The RMW provides a framework for grouping multiple, independent Rev-Trac Requests (RTRs) into a parent \"Release Request\".", React.createElement(Sup, null, "14"), " The main screen of the RMW typically presents a three-pane layout: Releases, Assigned Changes, and Candidate Changes.", React.createElement(Sup, null, "37")),
      React.createElement(H3, null, "6.2 Building, Managing, and Locking a Release"),
      P("Using a drag-and-drop interface, a Release Manager can select one or more \"candidate\" RTRs... and drop them onto the desired Release Request.", React.createElement(Sup, null, "37"), " Once the scope... has been finalized... the Release Manager can lock the release.", React.createElement(Sup, null, "37"), " Locking is a critical governance step that prevents any further RTRs from being added to or removed from the release."),
      ...
      P("The primary efficiency gain... comes at the time of deployment. Instead of requiring someone to individually approve... dozens or even hundreds of RTRs... the RMW enables a mass deployment from a single approval action.", React.createElement(Sup, null, "15"), " Upon approval, a single authorized user... applies one digital signature to the parent Release Request.", React.createElement(Sup, null, "35"), " This single action triggers the migration of all transports contained within the release."),
      React.createElement(H3, null, "6.4 Applying Release-Level Safety Checks"),
      P("The RMW allows for the execution of Rev-Trac's advanced safety checks at the release level before the go-live begins. The Release Manager can initiate an OOPS check or a dependency check against the entire collection of transports in the locked release.", React.createElement(Sup, null, "30"), " This pre-emptive validation is incredibly powerful... allow[ing] the Release Manager to proactively correct the content of the release... before deployment begins.")
    )
  },
  {
    id: 'modal-ch7',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("The true power of Rev-Trac Platinum is realized when it becomes the central orchestration engine for SAP changes within the larger enterprise DevOps toolchain. This integration is facilitated by the Rev-Trac WebCore."),
      ...
      P("The integration between Rev-Trac and ServiceNow... connects enterprise-level IT Service Management (ITSM) with technical SAP change execution.", React.createElement(Sup, null, "12"), " The bi-directional data flow enables a unified workflow that provides visibility to all stakeholders in their native tools.", React.createElement(Sup, null, "10")),
      ...
      P("For organizations employing Agile methodologies... the integration with Jira is essential.", React.createElement(Sup, null, "11"), " A key feature... is Enhanced References. A single business requirement, such as a Jira User Story, may require work from multiple developers... This results in multiple Jira sub-tasks.", React.createElement(Sup, null, "42"), " Instead of creating a separate RTR for each sub-task, Enhanced References allows all of these related Jira sub-tasks to be linked to a single, parent RTR.", React.createElement(Sup, null, "42")),
      React.createElement(H3, null, "7.4 Connecting with SAP Cloud ALM"),
      P("With SAP Solution Manager approaching its end-of-mainstream-maintenance... Rev-Trac provides... a robust integration that allows organizations to adopt Cloud ALM without sacrificing mature change management capabilities.", React.createElement(Sup, null, "23")),
      P("In this integrated scenario, Rev-Trac acts as the powerful, enforcement-driven change management engine, while Cloud ALM serves as the project management and requirements traceability layer.", React.createElement(Sup, null, "23"))
    )
  },
  {
    id: 'modal-ch8',
    ...
    content: React.createElement(ChapterContentWrapper, null,
      P("The final chapter... focuses on the long-term operational aspects of managing Rev-Trac. This includes leveraging its powerful reporting features for governance and compliance, adhering to security and administrative best practices, and understanding how to troubleshoot common issues."),
      React.createElement(H3, null, "8.1 Generating Audit-Ready Reports for Compliance"),
      P("A primary benefit of implementing Rev-Trac is the dramatic simplification of internal and external audits.", React.createElement(Sup, null, "1")),
      ...
      P("The performance of Rev-Trac is directly tied to the health of the SAP Master System on which it runs. Standard SAP Basis performance monitoring and tuning practices are essential."),
      ...
      P("Symptom: A user approves a migration, but the RTR does not proceed and an OOPS error is logged.", React.createElement(Sup, null, "22"), " Solution: Open the OOPS report from the Rev-Trac Workbench to identify the conflicting objects and transports and resolve the sequence issue.", React.createElement(Sup, null, "32")),
      React.createElement(H4, null, "Problem: Object Locking Prevents Development"),
      P("Symptom: A developer... receives a message that the object is locked by another Rev-Trac request.", React.createElement(Sup, null, "27"), " Solution: Coordinate with the owner of the locking RTR. In urgent cases, an authorized administrator can manually approve parallel development."),
      React.createElement(H4, null, "Problem: Automated Migration Fails"),
      P("Symptom: An RTR is approved for migration, but the transport does not appear in the import history of the target system. Solution: Check the Rev-Trac migration log, then use standard Basis tools (transport logs, SM21) to check the underlying SAP infrastructure.")
    )
  },
  {
    id: 'modal-conclusion',
